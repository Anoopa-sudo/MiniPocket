...
<body>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a class="" href="check-users.php" style="color: #fff; font-weight: bold">Manage Users</a></li>
    ...
    <div class="container regs-con">
        ...
        <table class="table table-bordered" id="student-tab">
            <tr>
                <th>User Email</th>
                <th>Name</th>
                <th>Phone</th>
            ...
            $sql = "SELECT email, fullname, phone, location FROM user";
